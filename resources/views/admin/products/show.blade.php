                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <x-jet-input type="text" name="product" class="w-full text-xs " value="{{$Product->product}}"/>
                                <x-jet-input-error for='product' />
                            </div>
                            <div class="form-group">
                                <x-jet-label value="SKU" />
                                <x-jet-input type="text" name="sku" class="w-full text-xs " value="{{$Product->sku}}"/>
                                <x-jet-input-error for='sku' />
                            </div>
                            <div class="form-group">
                                <x-jet-label value="Familia" />
                                <x-jet-input type="text" name="family" class="w-full text-xs " value="{{$Product->family}}"/>
                                <x-jet-input-error for='family' />
                            </div>
                            <div class="form-group">
                                <x-jet-label value="* Retenciones" />
                                <x-jet-input type="number" step="0.01" name="tax" class="w-full text-xs " value="{{$Product->tax}}"/>
